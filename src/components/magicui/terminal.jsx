...
export const TypingAnimation = ({
  ...
  useEffect(() => {
    ...
    return () => { if (typingEffect) clearInterval(typingEffect) }
...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={`border-border bg-background z-0 h-full max-h-100 w-full max-w-lg rounded-xl border ${className || ''}`}
    >

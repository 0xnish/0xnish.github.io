...
export default function InkbleedCursor() {
    ...
    useEffect(() => {
        ...
        const count = Math.max(1, DEFAULTS.pixelCount);
    ...
    useEffect(() => {
        for (const p of poolRef.current) {
            ...
            s.borderRadius = DEFAULTS.pixelShape === "circle" ? "50%" : "0";
    ...
    useEffect(() => {
        ...
        const frame = (now) => {
            ...
            p.trailColor = isLightMode() ? LIGHT_COLOR : DARK_COLOR;
...
InkbleedCursor.displayName = "InkbleedCursor";

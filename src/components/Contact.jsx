  ...
  return (
    <section className="contact-section" id="contact">
      ...
      <div className="contact-links" id="clinks">
        <a href="mailto:mailtonishii@gmail.com" className="ci ci-email">
          <div className="ci-iw">
          ...
          <div className="ci-val">mailtonishii@gmail.com</div>
        </a>
        <a href="https://github.com/coder-nishanth" target="_blank" rel="noopener" className="ci ci-github">
          <div className="ci-iw">
          ...
          <div className="ci-val">coder-nishanth</div>
        </a>
        <a href="https://www.linkedin.com/in/nishanth-jp" target="_blank" rel="noopener" className="ci ci-linkedin">
          <div className="ci-iw">
            <svg viewBox="0 0 24 24" width="28" height="28">
          ...
          <div className="ci-val">Nishanth J P</div>
        </a>
        <a href="https://instagram.com/ni.sh.x" target="_blank" rel="noopener" className="ci ci-instagram">
          <div className="ci-iw">
            <svg viewBox="0 0 24 24" width="28" height="28">
          ...
          <div className="ci-val">@ni.sh.x</div>
        </a>
      </div>
    </section>
  )
